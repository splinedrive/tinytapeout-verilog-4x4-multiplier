...
set ::env(DESIGN_NAME) scan_wrapper_341493393195532884
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341493393195532884.v \
$::env(DESIGN_DIR)/scan_wrapper_341493393195532884.v"
